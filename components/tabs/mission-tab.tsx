        ...
        <div className="space-y-8 text-gray-900">
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-900 leading-relaxed">
              We are CultureBites, a community platform built on one simple idea: people bond best over food. In an age
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-900 leading-relaxed mt-3 italic">
              CultureBites transforms a simple meal into an exchange of identity, memory, and kindness.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-900 leading-relaxed mb-3">
              CultureBites is inspired by the Humanity 101 principles of Compassion, Empathy, Kindness, and Respect.
            </p>
          ...
          <section className="space-y-3">
            ...
            <p className="text-gray-900 leading-relaxed">
              CultureBites follows the Safe Space and Humanities 101 Pledge: to create inclusive, judgment-free
          ...
          <section className="space-y-3">
            ...
            <p className="text-center text-xl font-semibold text-gray-900 mt-4">
              CultureBites — Meet. Greet. Eat. Repeat.
            </p>
          </section>
        </div>
      </GlassCard>
